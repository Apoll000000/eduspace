...
function CreateModalChannel({ channelDetails, token }) {
    ...
    return (
        <>
            <dialog id="create_modal_channel" className="modal">
                <div className="modal-box">
                    ...
                    <form method="dialog" onSubmit={handlePostSubmit}>
                        ...
                        <div className="flex justify-end mt-2 w-full gap-2">
                            <button className="btn btn-neutral" onClick={() => document.getElementById("create_modal_channel").close()}>Cancel</button>
...
export default CreateModalChannel;
