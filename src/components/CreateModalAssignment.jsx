...
function CreateModalAssignment({ channelDetails, token }) {
    ...
    const handlePostSubmit = async (e) => {
        ...
        //     post_channel: channelDetails.channel_code,
    ...
    const renderContent = () => {
        switch (activeTab) {
            case "assignment":
                return (
                    <div>
                        <h2 className="text-lg font-bold">Create a General Assignment</h2>
                        <textarea
            ...
            case "quiz":
                return (
                    <div>
                        <h2 className="text-lg font-bold">Create a Quiz</h2>
                        <textarea
                            className="textarea textarea-bordered w-full mb-4"
    ...
    return (
        <>
            <dialog id="create_modal_assignment" className="modal">
                <div className="modal-box">
                    ...
                    <form method="dialog" onSubmit={handlePostSubmit}>
                        <div role="tablist" className="tabs tabs-boxed">
                            <a
                                role="tab"
                                className={`tab ${activeTab === "assignment" ? "tab-active" : ""
                                    }`}
                            ...
                            <a
                                role="tab"
                                className={`tab ${activeTab === "exam" ? "tab-active" : ""
                                    }`}
                        ...
                        <div className="flex justify-end mt-2 w-full gap-2">
                            <button className="btn btn-neutral" onClick={() => document.getElementById("create_modal_assignment").close()}>Cancel</button>
...
export default CreateModalAssignment;
